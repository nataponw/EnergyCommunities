...
function initializeModel(
    ...
    m[:inttrade_fee_el] = JuMP.Containers.DenseAxisArray(reshape(pSca.inttrade_fee_el, nPeer), sPeer)
    m[:inttrade_fee_th] = JuMP.Containers.DenseAxisArray(reshape(pSca.inttrade_fee_th, nPeer), sPeer)
